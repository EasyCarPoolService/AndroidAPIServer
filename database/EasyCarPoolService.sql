...
--
-- Table structure for table `accuse_entity`
--

DROP TABLE IF EXISTS `accuse_entity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `accuse_entity` (
  `id` int NOT NULL AUTO_INCREMENT,
  `accuse_type` varchar(100) DEFAULT NULL,
  `accused_nickname` varchar(100) DEFAULT NULL,
  `accuser_nickname` varchar(100) DEFAULT NULL,
  `accuse_content` text,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `accuse_entity`
--

LOCK TABLES `accuse_entity` WRITE;
/*!40000 ALTER TABLE `accuse_entity` DISABLE KEYS */;
INSERT INTO `accuse_entity` VALUES (1,'욕설, 비속어 사용','testuser','lees','test accuse');
/*!40000 ALTER TABLE `accuse_entity` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `report_entity` (
  ...
  `report_content` text,
  `report_user_email` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `report_entity`
--

LOCK TABLES `report_entity` WRITE;
/*!40000 ALTER TABLE `report_entity` DISABLE KEYS */;
INSERT INTO `report_entity` VALUES (1,'test title','test content','lee');
/*!40000 ALTER TABLE `report_entity` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-03-19 14:38:41
